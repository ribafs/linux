# Scripts úteis que melhoram nossa performance

Estes scripts devem ser úteis para você também, nem que seja para o inspirar a criar os teus.

## Relação de scripts 

Para agilizar as tarefas mais frequentemente utilizadas

Quando não requer parâmetro uso um alias. Para os que precisam de parâmetro uso script com $1, $3, ...

## ubin - este script me ajuda a criar scripts para o /usr/local/bin, juntamente com o umod
```bash 
