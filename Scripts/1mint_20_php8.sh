...
# apt install -y php8.0 php8.0-bcmath php8.0-gd php8.0-mysql php8.0-pgsql php8.0-pdo-pgsql php8.0-sqlite php8.0-curl;
apt install -y php8.0 php8.0-bcmath php8.0-gd php8.0-mysql php8.0-pdo-mysql php8.0-curl;
